...
CREATE INDEX idx_availability_timestamp ON ali_parking_availability_minute_lot38 (minute_timestamp);
CREATE INDEX idx_availability_lot_timestamp ON ali_parking_availability_minute_lot38 (parking_lot_id, minute_timestamp);