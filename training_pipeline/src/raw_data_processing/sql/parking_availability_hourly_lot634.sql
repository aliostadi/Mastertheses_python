...
CREATE INDEX IF NOT EXISTS idx_parking_availability_minute_timestamp634 
ON ali_parking_availability_minute_lot634 (minute_timestamp);
...
CREATE TABLE ali_parking_availability_hourly_lot634 AS
WITH hourly_aggregation AS (
    ...
    FROM ali_parking_availability_minute_lot634
...
CREATE INDEX IF NOT EXISTS idx_parking_hourly_timestamp634 
ON ali_parking_availability_hourly_lot634 (hour_timestamp);

CREATE INDEX IF NOT EXISTS idx_parking_hourly_hour_of_day634 
ON ali_parking_availability_hourly_lot634 (hour_of_day);

CREATE INDEX IF NOT EXISTS idx_parking_hourly_day_of_week634 
ON ali_parking_availability_hourly_lot634 (day_of_week);

CREATE INDEX IF NOT EXISTS idx_parking_hourly_avg_free_spaces634 
ON ali_parking_availability_hourly_lot634 (avg_free_spaces);

CREATE INDEX IF NOT EXISTS idx_parking_hourly_day_of_month634 
ON ali_parking_availability_hourly_lot634 (day_of_month);

CREATE INDEX IF NOT EXISTS idx_parking_hourly_calendar_week634 
ON ali_parking_availability_hourly_lot634 (calendar_week);

CREATE INDEX IF NOT EXISTS idx_parking_hourly_month_number634 
ON ali_parking_availability_hourly_lot634 (month_number);
