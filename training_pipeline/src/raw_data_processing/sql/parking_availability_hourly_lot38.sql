...
CREATE INDEX if NOT EXISTS   idx_parking_hourly_hour_of_day 
ON ali_parking_availability_hourly_lot38 (hour_of_day);

CREATE INDEX if NOT EXISTS idx_parking_hourly_day_of_week 
ON ali_parking_availability_hourly_lot38 (day_of_week);

CREATE INDEX if NOT EXISTS   idx_parking_hourly_avg_free_spaces 
ON ali_parking_availability_hourly_lot38 (avg_free_spaces);

CREATE INDEX if NOT EXISTS idx_parking_hourly_day_of_month 
ON ali_parking_availability_hourly_lot38 (day_of_month);

CREATE INDEX if NOT EXISTS   idx_parking_hourly_calendar_week 
ON ali_parking_availability_hourly_lot38 (calendar_week);

CREATE INDEX if NOT EXISTS idx_parking_hourly_month_number 
